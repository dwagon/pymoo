...
def initial_data(apps, schema_editor):
    ...
    BB(name='Planetary Barrier Shield', cost=500, maint=5, required=t, desc="""A Planetary Barrier Shield seals a planet in a nearly impenetrable energy field. This shield converts Radiated climates into Barren by reducing solar radiation. It also protects the colony from orbital bombardment, reducing all damage against a planet by 20 points per attack. As long as the barrier shield is in place, neither ground troops nor biological weapons can enter the planet’s atmosphere.""").save()
